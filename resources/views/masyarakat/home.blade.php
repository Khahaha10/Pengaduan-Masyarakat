            ...
            <div class="col-md-12">
                ...
                <div class="row main-content1 table-container d-flex justify-content-center align-items-center" style="max-height: 760px; padding: 20px">
                    ...
                    <div class="w-100 d-flex justify-content-start mt-1">
                        <h2>Welcome! {{ Auth::user()->nama_masyarakat }}</h2>
                    </div>
                    ...
                    <div class="row w-100 d-flex justify-content-center mt-1">
                        <div class="col-md-3 mb-4">
                            <div class="card text-center back-primary text-white">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <span style="font-size: 24px; font-weight: bold;">{{ $jumlahPengaduanUser  }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card text-center back-warning text-white">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <span style="font-size: 24px; font-weight: bold;">{{ $jumlahPengaduanUser - ($jumlahPengaduanDiverifikasi + $jumlahPengaduanDitolak) }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card text-center back-success text-white">
                                <div class="card-body">
                                    <h5 class="card-title">Pengaduan Diverifikasi</h5>
                                    <p class="card-text">
                                        <span style="font-size: 24px; font-weight: bold;">{{ $jumlahPengaduanDiverifikasi  }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card text-center back-danger text-white">
                                <div class="card-body">
                                    <h5 class="card-title">Pengaduan Ditolak</h5>
                                    <p class="card-text">
                                        <span style="font-size: 24px; font-weight: bold;">{{ $jumlahPengaduanDitolak  }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <canvas id="pengaduanChart" width="400" height="190"></canvas>
                        </div>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const data = {
            labels: ['Total Pengaduan', 'Pending', 'Diverifikasi', 'Ditolak'],
            datasets: [{
                label: 'Jumlah Pengaduan',
                data: [
                    {{ intval($jumlahPengaduanUser) }},
                    {{ intval($jumlahPengaduanUser - ($jumlahPengaduanDiverifikasi + $jumlahPengaduanDitolak)) }},
                    {{ intval($jumlahPengaduanDiverifikasi) }},
                    {{ intval($jumlahPengaduanDitolak) }}
                ],
                backgroundColor: [
                    'rgba(54, 162, 235, 0.5)', 
                    'rgba(255, 206, 86, 0.5)', 
