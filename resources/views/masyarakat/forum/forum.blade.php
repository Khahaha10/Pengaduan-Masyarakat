    ...
    <div class="d-flex col-md-12">
        <div class="col-md-12">
            ...
            <div class="row main-content1 table-container">
                <div class="text-center mb-4 mt-2 sticky-create-btn">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createForumModal">
                        <i class='bx bx-plus' style="font-size: 16px;"></i> Buat Forum Topik Baru
                    </button>
                </div>
                                ...
                                <div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex justify-content-start align-items-center">
                                            ...
                                            @endif
                                            <button class="btn" data-bs-toggle="modal" style="padding: 0; display: flex; align-items: center; gap: 5px;" data-bs-target="#replyForumModal-{{ $forum->id_forum }}">
                                                Reply <i class='bx bx-comment-dots' style="font-size: 20px;"></i>
                                            </button>
                                        </div>

                                        @if(Auth::user()->id_masyarakat == $forum->id_masyarakat)
                                            <div class="d-flex justify-content-end">
                                                <button type="button" class="btn btn-outline-info btn-icon" data-bs-toggle="modal" data-bs-target="#editForumModal-{{ $forum->id_forum }}">
                                    ...
                                    <div class="replies-container mt-3" id="replies-{{ $forum->id_forum }}" style="display: none;">
                                        @foreach ($forum->komentarPadaForum as $comment)
                                                    ...
                                                    <div class="ms-5 mt-2">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            @if(Auth::user()->id_masyarakat == $comment->id_masyarakat)
                                                                <div class="d-flex">
                                                                    <button class="btn btn-outline-info btn-sm" data-bs-toggle="modal" data-bs-target="#editKomentarModal-{{ $comment->id_komentar }}">
                                            ...
                                            @include('masyarakat.forum.komen_edit', ['comment' => $comment] )
                                            @include('masyarakat.forum.komen_delete', ['comment' => $comment] )
                ...
                @include('masyarakat.forum.forum_edit', ['forum' => $forum])
                @include('masyarakat.forum.forum_delete', ['forum' => $forum])
...
@include('masyarakat.forum.forum_create')

@include('masyarakat.forum.komen_create', ['forum' => $forum])
@endsection
